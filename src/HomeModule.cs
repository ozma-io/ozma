namespace FunWithFlags.FunApp
{
    ...
    public class HomeModule : NancyModule
    {
        ...
        {        
            ...
            // ! Переписать функционал под ID разных юзервью, сюда же ID сущности и параметры (соритровка)
            Get("/tabl", _ =>
            {
                /*
            ...
            // ! Переписать функционал под ID разных формы, сюда же ID сущности, ID записи
            Get("/form", _ =>
            {
                /*
                Создаем модель меню, берем данные из базы с доступами пользователя к сущности и представлениям
