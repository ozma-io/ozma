<template>
  ...
  >
    <ButtonContent :button="button" :phantom-icon="phantomIcon" list-item />
  </b-list-group-item>
  ...
  <b-button
    ...
    :class="[
      variantClassName,
      'button-local-variant',
      alignRight ? '' : 'd-flex justify-content-center',
      buttonClass,
    ]"
...
export default class ButtonView extends Vue {
  ...
  private get listItemVariant(): string {
    return this.button.variant.type === 'existing'
      ? this.button.variant.className
      : 'light'
  }
